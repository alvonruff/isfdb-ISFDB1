...
static char sccsid[] = "@(#)pinfo.c	1.6	01/28/98 SFdbase";
	...
	char	*argv[];
{
	...
	printf("<html><head>\n");
	printf("<title>Publication Correction Selection</title></head>\n");
	printf("<body bgcolor=#ffff80>\n");
	printf("<h1>Publication Correction Selection</h1><hr>\n");
	printf("To make a correction to a particular work, select the\n");
	printf("[c] anchor to the left of the errant work. If you wish\n");
	printf("to add a new publication, just select one of the existing pubs\n");
	printf("and change the relevant fields (this will save entry time\n");
	printf("on collections and anthologies).\n");
	printf("<pre>\n");
	...
	print_pub_citations( title_list->se_pubs, 1 );
	postamble("pinfo", argv[1]);
